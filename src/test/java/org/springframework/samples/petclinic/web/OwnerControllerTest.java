...
class OwnerControllerTest {
    ...
    @Test
    void initFormCreationTest() throws Exception {
    ...
    void testFindOwnerOneResult() throws Exception {
        ...
        given(clinicService.findOwnerByLastName(owner.getLastName())).willReturn(Lists.newArrayList(owner));
        mockMvc.perform(get("/owners")
